...
const NavBar = ({ scrollTo }) => {
  return (
    <div className='nav-container' >
      ...
      <p className="nav-links" onClick={() => scrollTo(3)} >Achievements</p>
      <p className="nav-links" onClick={() => scrollTo(4)} >Projects</p>
      <p className="nav-links" onClick={() => scrollTo(5)} >Skills</p>
      <p className="nav-links" onClick={() => scrollTo(6)} >Contact</p>
    </div>
  );
}
